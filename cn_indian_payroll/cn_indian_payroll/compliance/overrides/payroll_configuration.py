    ...
    try:
        ...
        if component and salary_component:
            ...
            if len(existing_components) > 0:
                ...
                get_each_doc.custom_tax_exemption_applicable_based_on_regime = data.get(
                ...
                get_each_doc.payout_unclaimed_amount_in_final_payroll_cycle = data.get(
                    "payout_unclaimed_amount_in_final_payroll_cycle"
                )
