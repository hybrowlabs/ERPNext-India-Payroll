...
def generate_ctc_pdf(employee, salary_structure, posting_date=None, employee_benefits=None):
    ...
    if not frappe.has_permission("Employee", "read", employee):
        frappe.throw(_("Not permitted to access this employee's CTC."), frappe.PermissionError)
    ...
    if not slip:
        frappe.throw(_("Unable to generate salary breakup. Check Salary Structure or Employee."))
