frappe.pages['income-tax-calculato'].on_page_load = function(wrapper) {
	...
	$("#tableblock").hide();
	frappe.db.get_value('Income Tax Slab', 'Old Regime', 'standard_tax_exemption_amount')
    .then(r => {
        $("#stdeduction").empty().append((r.message.standard_tax_exemption_amount).toFixed(2))
    })
}
// Jquery Dependency
...
function calculatetax(){
    ...
    .then(r => {
  	...
  	var enteredAmount = total_deduction+parseInt(r.message.standard_tax_exemption_amount);
