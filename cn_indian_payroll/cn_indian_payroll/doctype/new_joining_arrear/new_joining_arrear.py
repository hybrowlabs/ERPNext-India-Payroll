...
class NewJoiningArrear(Document):
    ...
    def insert_breakup_table(self):
        ...
        frappe.get_doc("Salary Structure Assignment", salary_structure_assignment[0].name)
                ...
                reimbursement_components.append(
                    {
                        ...
                        "amount": round(
                            (accrued_benefit.amount / new_salary_slip.total_working_days)
                ...
                reimbursement_components.append(
                    {
                        "salary_component": accrued_benefit.salary_component,
                        "amount": round(
                            ((accrued_benefit.amount / 12) / new_salary_slip.total_working_days)
                            * self.number_of_present_days
                        ),
                        "custom_actual_amount": round(accrued_benefit.amount),
                    }
