...
def get_lop_reversal(filters=None):
    ...
    for row in records:
        ...
        row_data = {
            ...
            "paid_days": getattr(row, "paid_days", 0),
...
def get_columns(components):
    base_columns = [
        ...
        {"label": "Paid Days", "fieldname": "paid_days", "fieldtype": "Float", "width": 120},
...
#             row_data[f"{e.salary_component}_actual"] = e.actual_amount
#             row_data[e.salary_component] = e.amount
#             all_components.add(e.salary_component)

#         # Add deductions
#         for d in arrear_doc.deduction_component or []:
#             row_data[f"{d.salary_component}_actual"] = d.actual_amount
#             row_data[d.salary_component] = d.amount
#             all_components.add(d.salary_component)
...
#     # For each salary component, add two columns: Actual Amount + Amount
#     component_columns = []
#     for comp in components:
#         component_columns.append(
#             {"label": f"{comp} (As per CTC)", "fieldname": f"{comp}_actual", "fieldtype": "Currency", "width": 120}
#         )
#         component_columns.append(
#             {"label": f"{comp} (As per Arrear)", "fieldname": comp, "fieldtype": "Currency", "width": 120}
#         )
