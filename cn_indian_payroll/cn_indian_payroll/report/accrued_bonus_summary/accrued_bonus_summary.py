...
def get_columns(data):
    ...
    for i in range(1, max_entries + 1):
        columns.extend([
            {"label": f"Date", "fieldname": f"date_{i}", "fieldtype": "Date", "width": 120},
            {"label": f"Working Days", "fieldname": f"working_days_{i}", "fieldtype": "Float", "width": 100},
            {"label": f"Payment Days", "fieldname": f"payment_days_{i}", "fieldtype": "Float", "width": 100},
            {"label": f"LWP", "fieldname": f"lwp_{i}", "fieldtype": "Float", "width": 80},
            {"label": f"Accrued Amount", "fieldname": f"amount_{i}", "fieldtype": "Currency", "width": 120},
        ])
