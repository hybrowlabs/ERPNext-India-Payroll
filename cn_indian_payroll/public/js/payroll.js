...
//     custom_create_extra_payment_deduction(frm)
//     {
...
//             let btn = frm.fields_dict.custom_process_regularize.$input;
//             let btn_1 = frm.fields_dict.custom_create_extra_payment_deduction.$input;
//             let btn_2 = frm.fields_dict.custom_create_offcycle.$input;
...
frappe.ui.form.on('Payroll Entry', {
    ...
    custom_create_extra_payment_deduction(frm)
    {
         ...
         frappe.confirm(
        "Are you sure you want to process Extra Payment/Deduction data?",
        () => {
    ...
    custom_create_offcycle(frm)
    {
         ...
         frappe.confirm(
        "Are you sure you want to process Offcycle data?",
        () => {
        frappe.call({
                method: "cn_indian_payroll.cn_indian_payroll.overrides.payroll_config.create_offcycle_payment",
                args: {
